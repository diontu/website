import FooterSocials, { Socials } from '@/components/footer/footer-socials'
import FooterCopyright, {
    CopyrightDetails,
} from '@/components/footer/footer-copyright'

// TODO: make this more customizable with props
// TODO: add customization for contact and the "about" section of the footer? -- project links too?
type FooterProps = {
...
const Footer = (props: FooterProps): JSX.Element => {
    return (
        <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
            {props.socials && <FooterSocials socials={props.socials} />}
